...
class SettingBarberman extends StatefulWidget {
  const SettingBarberman({Key? key}) : super(key: key);

  @override
  _SettingBarbermanState createState() => _SettingBarbermanState();
}

class _SettingBarbermanState extends State<SettingBarberman> {
